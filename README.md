...
Stage32.6 applies to the rejected concept-sheet/crop-card runtime path, not to the Stage32.5 transparent source PNG package. The old generated proxy kit remains available through `.\tools\run-stage32-terrain-kit-generator.ps1` for debug/review and fallback only.
