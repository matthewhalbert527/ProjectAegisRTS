...
- Terrain texture repetition: production terrain now uses smaller semantic patches and material tiling rather than stretching one large debug-like dominant role over 16 cells. Production preview also remaps cliff/rough river shoulders to lighter dirt surfaces so imported cliff pieces and wet-bank meshes, not flat gray masks, carry the river edge.
