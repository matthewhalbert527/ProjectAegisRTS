...
`AegisResourceSimulation` in `src/Rts.Core/Maps/Generation` provides a small deterministic test harness for resource fields. It covers depletion, hidden/depleted state, delay, rate, max cap, and repeatability.
