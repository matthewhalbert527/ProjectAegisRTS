# ProjectAegisRTS Unit Packet: Scout Rover
...
unit:
  type_id: scout_rover
  display_name: Scout Rover
  actor_kind: Unit
  category: Vehicle
  role: fast reconnaissance rover with roof-mounted machine gun
  max_health: 240
...
movement:
  speed_per_tick: 15
  turn_rate_degrees_per_tick: 8
  visual_motion_profile_id: wheeled_scout
  movement_class: Wheeled

combat:
  has_weapon: true
  weapon: scout_rover_762mm_machine_gun
...
visual_assets:
  source_model:
    path: unity/Assets/Rts/Art/Source/Units/scout_rover/scout_rover.obj
    format: obj
  ...
  textures:
    albedo: unity/Assets/Rts/Art/Textures/Units/scout_rover/scout_rover_albedo.png
    normal: unity/Assets/Rts/Art/Textures/Units/scout_rover/scout_rover_normal.png
    orm_or_roughness: unity/Assets/Rts/Art/Textures/Units/scout_rover/scout_rover_orm.png
    emission: unity/Assets/Rts/Art/Textures/Units/scout_rover/scout_rover_emission.png
    team_mask: unity/Assets/Rts/Art/Textures/Units/scout_rover/scout_rover_team_mask.png
    projectile_albedo: unity/Assets/Rts/Art/Textures/Units/scout_rover/scout_rover_projectile_tracer.png
    muzzle_flash_sheet: unity/Assets/Rts/Art/Textures/Units/scout_rover/scout_rover_muzzle_flash_sheet.png
    icon: unity/Assets/Rts/Art/Icons/scout_rover_icon.png

  reference_images:
    concept_front: build/screenshots/units/scout_rover_front.png
    concept_side: build/screenshots/units/scout_rover_side.png
    concept_top: build/screenshots/units/scout_rover_top.png
    concept_three_quarter: build/screenshots/units/scout_rover_three_quarter.png
```
...
scale_and_pivots:
  ...
  visual_length_meters: 4.88
  visual_width_meters: 4.33
  visual_height_meters: 2.71
  root_origin: ground_center
  forward_axis: +Z
  turret_default_yaw_degrees: 0
  selection_radius: 1.95
  selection_height: 3.35
...
| TurretRoot | yes | 0.00,2.21,-0.03 | 0,0,0 | Roof turret yaw pivot |
| BarrelRoot | yes | 0.00,2.49,0.42 | 0,0,0 | Barrel pitch/recoil root |
| MuzzlePrimary | yes | 0.00,2.49,1.24 | 0,0,0 | Weapon muzzle |
| WheelLeft | yes | -1.92,0.60,0.00 | 0,0,0 | Left wheel group |
| WheelRight | yes | 1.92,0.60,0.00 | 0,0,0 | Right wheel group |
| SelectionAnchor | yes | 0.00,0.08,-0.18 | 0,0,0 | Selection ring center |
| HealthBarAnchor | yes | 0.00,3.11,-0.30 | 0,0,0 | Health bar anchor |
| UiAnchor | yes | 0.00,3.35,-0.30 | 0,0,0 | Floating UI anchor |
| VfxSmoke | yes | 0.76,1.75,-1.90 | 0,0,0 | Exhaust/damage smoke |
| VfxExplosion | yes | 0.00,1.08,-0.18 | 0,0,0 | Death explosion center |
| LightRoot | yes | 0.00,0.86,2.18 | 0,0,0 | Headlight cluster |
| AimPivot | yes | 0.00,2.34,0.17 | 0,0,0 | Presentation aim helper |
...
combat:
  has_weapon: true
  weapon_id: scout_rover_762mm_machine_gun
  display_name: 7.62mm Scout Machine Gun
  damage: 18
  damage_kind: Kinetic
  range_cells: 4
  min_range_cells: 0
  ...
  projectile_speed_subcells_per_tick: 96
  ...
  projectile_visual_id: scout_rover_762mm_machine_gun_projectile
...
projectile_visual:
  ...
  projectile_mesh_or_sprite: scout_rover_projectile_tracer.png
  tracer_color: amber
  tracer_length: 0.55
  muzzle_flash_texture: scout_rover_muzzle_flash_sheet.png
...
```text
unity/Assets/Rts/Art/Source/Units/scout_rover/
unity/Assets/Rts/Art/Textures/Units/scout_rover/
unity/Assets/Rts/Art/Materials/Units/scout_rover/
unity/Assets/Rts/Art/Icons/scout_rover_icon.png
unity/Assets/Rts/Art/Prefabs/Actors/Production/Units/scout_rover/scout_rover.prefab
unity/Assets/Rts/ScriptableObjects/Art/ActorVisualDefinitions/scout_rover_visual.asset
unity/Assets/Rts/Scenes/scout_rover_UnitReview.unity
docs/units/scout_rover_UNIT_PACKET.md
```
...
- Actor id: `scout_rover`.
- Prefab root: `scout_rover`.
- Materials: `mat_scout_rover_body`, `mat_scout_rover_team`, `mat_scout_rover_metal`, `mat_scout_rover_glass`, `mat_scout_rover_emission`.
- Textures: `scout_rover_albedo.png`, `scout_rover_normal.png`, `scout_rover_orm.png`, `scout_rover_emission.png`, `scout_rover_team_mask.png`.
...
```yaml
screenshots:
  unit_review_scene: build/screenshots/units/scout_rover_socket_review.png
  player_facing_scene: build/screenshots/units/scout_rover_three_quarter.png
...
unit:
  ...
  comparable_existing_unit: scout_rover
...
visuals:
  ...
  model_files:
    - unity/Assets/Rts/Art/Source/Units/scout_rover/scout_rover_hull.obj
    - unity/Assets/Rts/Art/Source/Units/scout_rover/scout_rover_wheel_left.obj
    - unity/Assets/Rts/Art/Source/Units/scout_rover/scout_rover_wheel_right.obj
    - unity/Assets/Rts/Art/Source/Units/scout_rover/scout_rover_turret.obj
    - unity/Assets/Rts/Art/Source/Units/scout_rover/scout_rover_barrel.obj
    - unity/Assets/Rts/Art/Source/Units/scout_rover/scout_rover_team_body.obj
    - unity/Assets/Rts/Art/Source/Units/scout_rover/scout_rover_team_turret.obj
    - unity/Assets/Rts/Art/Source/Units/scout_rover/scout_rover_glass.obj
    - unity/Assets/Rts/Art/Source/Units/scout_rover/scout_rover_emissive.obj
    - unity/Assets/Rts/Art/Source/Units/scout_rover/scout_rover_dark_panel_details.obj
    - unity/Assets/Rts/Art/Source/Units/scout_rover/scout_rover_bolts_details.obj
    - unity/Assets/Rts/Art/Source/Units/scout_rover/scout_rover_projectile_bullet.obj
    - unity/Assets/Rts/Art/Source/Units/scout_rover/scout_rover_lod1.obj
    - unity/Assets/Rts/Art/Source/Units/scout_rover/scout_rover_lod2.obj
  texture_files:
    - unity/Assets/Rts/Art/Textures/Units/scout_rover/scout_rover_albedo.png
    - unity/Assets/Rts/Art/Textures/Units/scout_rover/scout_rover_normal.png
    - unity/Assets/Rts/Art/Textures/Units/scout_rover/scout_rover_orm.png
    - unity/Assets/Rts/Art/Textures/Units/scout_rover/scout_rover_emission.png
    - unity/Assets/Rts/Art/Textures/Units/scout_rover/scout_rover_team_mask.png
    - unity/Assets/Rts/Art/Textures/Units/scout_rover/scout_rover_muzzle_flash_sheet.png
    - unity/Assets/Rts/Art/Textures/Units/scout_rover/scout_rover_projectile_tracer.png
  icon_file: unity/Assets/Rts/Art/Icons/scout_rover_icon.png
  ...
  sockets:
    ...
    - socket: BodyRoot
      ...
      local_rotation: [0, 0, 0]
    - socket: TurretRoot
      local_position: [0.00, 2.21, -0.03]
      local_rotation: [0, 0, 0]
    - socket: BarrelRoot
      local_position: [0.00, 2.49, 0.42]
      local_rotation: [0, 0, 0]
    - socket: MuzzlePrimary
      local_position: [0.00, 2.49, 1.24]
      local_rotation: [0, 0, 0]
    - socket: WheelLeft
      local_position: [-1.34, 0.60, -0.14]
      local_rotation: [0, 0, 0]
    - socket: WheelRight
      local_position: [1.34, 0.60, -0.14]
      local_rotation: [0, 0, 0]
    - socket: SelectionAnchor
      local_position: [0.00, 0.08, -0.18]
      local_rotation: [0, 0, 0]
    - socket: HealthBarAnchor
      local_position: [0.00, 3.11, -0.30]
      local_rotation: [0, 0, 0]
    - socket: UiAnchor
      local_position: [0.00, 3.35, -0.30]
      local_rotation: [0, 0, 0]
    - socket: VfxSmoke
      local_position: [0.76, 1.75, -1.90]
      local_rotation: [0, 0, 0]
    - socket: VfxExplosion
      local_position: [0.00, 1.08, -0.18]
      local_rotation: [0, 0, 0]
    - socket: LightRoot
      local_position: [0.00, 0.86, 2.18]
      local_rotation: [0, 0, 0]
    - socket: AimPivot
      local_position: [0.00, 2.34, 0.17]
      local_rotation: [0, 0, 0]
...
unity_paths:
  source_folder: unity/Assets/Rts/Art/Source/Units/scout_rover/
  textures_folder: unity/Assets/Rts/Art/Textures/Units/scout_rover/
  materials_folder: unity/Assets/Rts/Art/Materials/Units/scout_rover/
  prefab_path: unity/Assets/Rts/Art/Prefabs/Actors/Production/Units/scout_rover/scout_rover.prefab
  visual_definition_path: unity/Assets/Rts/ScriptableObjects/Art/ActorVisualDefinitions/scout_rover_visual.asset
  review_scene_path: unity/Assets/Rts/Scenes/scout_rover_UnitReview.unity
...
acceptance:
  ...
  required_screenshots:
    - build/screenshots/units/scout_rover_three_quarter.png
    - build/screenshots/units/scout_rover_top.png
    - build/screenshots/units/scout_rover_front.png
    - build/screenshots/units/scout_rover_side.png
    - build/screenshots/units/scout_rover_socket_review.png
    - build/screenshots/units/scout_rover_team_color_readability.png
```

Triangle budget:

- LOD0: 2,552 triangles.
- LOD1: 300 triangles.
- LOD2: 44 triangles.
