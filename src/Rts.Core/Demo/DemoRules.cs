...
namespace ProjectAegisRTS.Demo
{
    public static class DemoRules
    {
        public static RtsRules CreateDefaultRules()
        {
            ...
            actors.Add(Building("advanced_power_plant", "Advanced Power Plant", 1200, ProductionKind.Building, 650, 32, "fabrication_hub", 80, 0, new Int2(2, 2), false, 0, new Int2(0, 2), new string[0], buildingAnimation, prerequisites: new[] { "tech_center" }));
            ...
            actors.Add(Building("field_hospital", "Field Hospital", 900, ProductionKind.Building, 450, 28, "fabrication_hub", 0, 6, new Int2(2, 2), false, 0, new Int2(1, 2), new string[0], buildingAnimation, prerequisites: new[] { "barracks" }));
            actors.Add(Building("comm_center", "Comm Center", 1000, ProductionKind.Building, 800, 45, "fabrication_hub", 0, 14, new Int2(2, 2), false, 0, new Int2(1, 2), new string[0], buildingAnimation, null, 7, new RadarDefinition(true, 20), new[] { "refinery" }));
            actors.Add(Building("repair_bay", "Repair Bay", 1100, ProductionKind.Building, 500, 30, "fabrication_hub", 0, 10, new Int2(3, 2), false, 0, new Int2(1, 2), new string[0], buildingAnimation, prerequisites: new[] { "war_factory" }));
        ...
        static UnitDefinition Unit(string typeId, string displayName, int health, ProductionKind productionKind, int cost, int buildTimeTicks, string factoryTypeId, int speedPerTick, int turnRate, string visualProfile, AnimationStateDefinition animation, WeaponDefinition weapon, int sightRadius = 4, IReadOnlyList<string> prerequisites = null, CaptureDefinition capture = null, TransportDefinition transport = null)
        {
            return new UnitDefinition(
                ...
                displayName,
                health,
                new ProductionDefinition(productionKind, cost, buildTimeTicks, factoryTypeId, false, prerequisites),
