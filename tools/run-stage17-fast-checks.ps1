...
Write-ValidationSection 'Stage 17 fast checks'
Write-Host 'Purpose: fast iteration for player-facing Stage 17 polish.'
Write-Host 'Scope: Rts.Core tests, Unity DLL build, Stage 17 Unity validation and smoke, medium recursion audit, Rts.Core UnityEngine scan, and git diff whitespace check.'
Write-Host 'This fast tier intentionally does not run Stage 1 through Stage 16 checks.'
...
Write-Host 'Stage 17 fast checks passed.'
