...
Write-ValidationSection 'Stage 18.5 fast checks'
Write-Host 'Purpose: fast iteration for fine placement grid changes.'
Write-Host 'Scope: Rts.Core tests, Unity DLL build, Stage 18.5 validation and smoke, medium recursion audit, Rts.Core UnityEngine scan, and git diff whitespace check.'
Write-Host 'This fast tier intentionally does not run Stage 1 through Stage 18 checks.'
...
Write-Host 'Stage 18.5 fast checks passed.'
