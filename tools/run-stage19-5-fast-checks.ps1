...
Write-ValidationSection 'Stage 19.5 fast checks'
Write-Host 'Purpose: fast iteration for the CnC-style PC sidebar and pause menu.'
Write-Host 'Scope: Rts.Core tests, Unity DLL build, Stage 19.5 validation and smoke, medium recursion audit, Rts.Core UnityEngine scan, and git diff whitespace check.'
Write-Host 'This fast tier intentionally does not run Stage 1 through Stage 19 checks.'
...
Write-Host 'Stage 19.5 fast checks passed.'
