...
Write-ValidationSection 'Stage 19 fast checks'
Write-Host 'Purpose: fast iteration for mission flow and fine-grid playability tuning.'
Write-Host 'Scope: Rts.Core tests, Unity DLL build, Stage 19 validation and smoke, medium recursion audit, Rts.Core UnityEngine scan, and git diff whitespace check.'
Write-Host 'This fast tier intentionally does not run Stage 1 through Stage 18.5 checks.'
...
Write-Host 'Stage 19 fast checks passed.'
