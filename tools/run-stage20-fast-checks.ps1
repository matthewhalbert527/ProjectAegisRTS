...
Write-ValidationSection 'Stage 20 fast checks'
Write-Host 'Purpose: targeted iteration for the Stage 20 MVP production visual replacement pass.'
Write-Host 'Scope: Rts.Core tests/build, Stage20 proxy generation/validation/scene/play smoke, direct Stage4/Stage5 hand-control validation, medium recursion audit, UnityEngine-free scan, and git diff whitespace check.'
...
Write-Host 'Stage 20 fast checks passed.'
