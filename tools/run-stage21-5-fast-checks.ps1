...
Write-ValidationSection 'Stage 21.5 fast checks'
Write-Host 'Purpose: targeted iteration for Windows player resolution/UI scaling.'
Write-Host 'Scope: core tests/build, display settings configuration, Stage21.5 display validation and smoke, medium recursion audit, UnityEngine-free scan, and git diff whitespace check.'
...
Write-Host 'Stage 21.5 fast checks passed.'
