...
Write-ValidationSection 'Stage 21 medium checks'
Write-Host 'Purpose: pre-commit confidence for Stage 21 MVP visual QA readiness.'
Write-Host 'Scope: Rts.Core tests/build, direct Stage20 Unity/player-facing validation, direct Stage4/Stage5 hand-control validation, Stage21 validation and smoke, Stage21 player-facing checks, medium recursion audit, UnityEngine-free scan, and git diff whitespace check.'
Write-Host 'This medium tier does not call prior medium checks. Use run-stage21-checks.ps1 for the slow full final acceptance gate.'
...
Write-ValidationSection 'Direct Stage 20 Unity validation'
...
Write-ValidationSection 'Direct Stage 20 player-facing validation'
...
Write-ValidationSection 'Stage 21 player-facing validation'
...
Write-Host 'Stage 21 medium checks passed.'
