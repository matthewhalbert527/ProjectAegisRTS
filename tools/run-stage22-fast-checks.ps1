...
Write-ValidationSection 'Stage 22 fast checks'
Write-Host 'Purpose: targeted iteration for classic RTS command controls.'
Write-Host 'Scope: core tests/build, Stage22 Unity validation and smoke, medium recursion audit, UnityEngine-free scan, and git diff whitespace check.'
...
Write-Host 'Stage 22 fast checks passed.'
