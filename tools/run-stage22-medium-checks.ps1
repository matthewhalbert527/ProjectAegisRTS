...
Write-ValidationSection 'Stage 22 medium checks'
Write-Host 'Purpose: pre-commit confidence for classic RTS command controls.'
Write-Host 'Scope: Rts.Core tests/build, direct Stage21.5 Unity/player-facing validation, direct Stage4/Stage5 hand-control validation, Stage22 Unity validation and smoke, Stage22 player-facing checks, medium recursion audit, UnityEngine-free scan, and git diff whitespace check.'
Write-Host 'This medium tier does not call prior medium checks. Use run-stage22-checks.ps1 for the slow full final acceptance gate.'
...
Write-ValidationSection 'Direct Stage 21.5 Unity validation'
...
Write-ValidationSection 'Direct Stage 21.5 player-facing validation'
...
Write-ValidationSection 'Stage 22 Unity validation'
...
Write-Host 'Stage 22 medium checks passed.'
