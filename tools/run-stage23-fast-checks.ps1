...
Write-ValidationSection 'Stage 23 fast checks'
Write-Host 'Purpose: targeted iteration for base management commands.'
Write-Host 'Scope: core tests/build, Stage23 Unity validation and smoke, medium recursion audit, UnityEngine-free scan, and git diff whitespace check.'
...
Write-Host 'Stage 23 fast checks passed.'
