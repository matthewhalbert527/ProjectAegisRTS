...
Write-ValidationSection 'Stage 24 fast checks'
Write-Host 'Purpose: targeted iteration for tech prerequisites and support powers.'
Write-Host 'Scope: core tests/build, Stage24 Unity validation and smoke, medium recursion audit, UnityEngine-free scan, and git diff whitespace check.'
...
Write-Host 'Stage 24 fast checks passed.'
