...
Write-ValidationSection 'Stage 24 medium checks'
Write-Host 'Purpose: pre-commit confidence for tech prerequisites and support powers.'
Write-Host 'Scope: Rts.Core tests/build, direct Stage23 Unity/player-facing validation, direct Stage4/Stage5 hand-control validation, Stage24 Unity validation and smoke, Stage24 player-facing checks, medium recursion audit, UnityEngine-free scan, and git diff whitespace check.'
Write-Host 'This medium tier does not call prior medium checks. Use run-stage24-checks.ps1 for the slow full final acceptance gate.'
...
Write-ValidationSection 'Direct Stage 23 Unity validation'
...
Write-ValidationSection 'Direct Stage 23 player-facing validation'
...
Write-ValidationSection 'Stage 24 Unity validation'
...
Write-Host 'Stage 24 medium checks passed.'
