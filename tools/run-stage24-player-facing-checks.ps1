...
Write-ValidationSection 'Stage 24 player-facing checks'
Write-Host 'Scope: core tests/build, medium recursion audit, direct Stage23 validation, Stage24 Unity validation, optional Windows player build/launch/log inspection, UnityEngine-free scan, and git diff whitespace check.'
...
Write-Host 'Stage 24 player-facing checks passed.'
