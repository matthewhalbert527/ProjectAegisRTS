...
Write-ValidationSection 'Stage 25 fast checks'
Write-Host 'Purpose: targeted iteration for engineers, capture, repairs, and transports.'
Write-Host 'Scope: core tests/build, Stage25 Unity validation and smoke, medium recursion audit, UnityEngine-free scan, and git diff whitespace check.'
...
Write-Host 'Stage 25 fast checks passed.'
