...
Write-ValidationSection 'Stage 26 fast checks'
Write-Host 'Purpose: targeted iteration for airfield, aircraft, helipad docking, and naval passability foundations.'
Write-Host 'Scope: core tests/build, Stage26 Unity validation and smoke, medium recursion audit, UnityEngine-free scan, and git diff whitespace check.'
...
Write-Host 'Stage 26 fast checks passed.'
