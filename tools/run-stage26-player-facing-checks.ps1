...
Write-ValidationSection 'Stage 26 player-facing checks'
Write-Host 'Scope: core tests/build, medium recursion audit, direct Stage25 validation, Stage26 Unity validation, optional Windows player build/launch/log inspection, UnityEngine-free scan, and git diff whitespace check.'
...
Write-Host 'Stage 26 player-facing checks passed.'
