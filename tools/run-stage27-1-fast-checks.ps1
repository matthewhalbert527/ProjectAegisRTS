...
Write-ValidationSection 'Stage 27.1 fast checks'
Write-Host 'Purpose: targeted iteration for PC building placement UX without rerunning prior stage chains.'
Write-Host 'Scope: core tests/build, Stage27.1 Unity placement validation and smoke, medium recursion audit, UnityEngine-free scan, and git diff whitespace check.'
...
Write-Host 'Stage 27.1 fast checks passed.'
