...
Write-ValidationSection 'Stage 27 fast checks'
Write-Host 'Purpose: targeted iteration for skirmish AI pressure, difficulty profiles, restart controls, and player-facing status.'
Write-Host 'Scope: core tests/build, Stage27 Unity validation and smoke, medium recursion audit, UnityEngine-free scan, and git diff whitespace check.'
...
Write-Host 'Stage 27 fast checks passed.'
