...
Write-ValidationSection 'Stage 28.1 medium checks'
Write-Host 'Purpose: pre-commit confidence for safe-area layout and flattened full-gate tooling without recursive medium chaining.'
Write-Host 'Scope: Rts.Core tests/build, direct Stage28 and Stage27.1 validation, Stage4/Stage5 hand controls, Stage28.1 Unity validation, Stage28.1 player-facing checks with Windows build skipped, recursion audits, UnityEngine-free scan, and git diff whitespace check.'
...
Write-ValidationSection 'Stage 28.1 Unity validation'
...
Write-Host 'Stage 28.1 medium checks passed.'
