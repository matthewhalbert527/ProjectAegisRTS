...
Write-ValidationSection 'Stage 28 fast checks'
Write-Host 'Purpose: targeted iteration for integrated feature-regression QA after Stage 27.1.'
Write-Host 'Scope: core tests/build, Stage28 Unity validation and smoke, medium recursion audit, UnityEngine-free scan, and git diff whitespace check.'
...
Write-Host 'Stage 28 fast checks passed.'
