...
Write-ValidationSection 'Stage 29 fast checks'
Write-Host 'Purpose: targeted iteration for realistic battlefield visuals, materials, MVP proxy detail, review scene, and visual QA.'
Write-Host 'Scope: Rts.Core tests/build, Stage29 Unity visual validation/smoke/screenshot, recursion audits, UnityEngine-free scan, and git diff whitespace check.'
...
Write-Host 'Stage 29 fast checks passed.'
