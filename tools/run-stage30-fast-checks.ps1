...
Write-ValidationSection 'Stage 30 fast checks'
Write-Host 'Purpose: targeted iteration for visual readability, camera/contrast QA, proxy distinguishability, and screenshot capture.'
Write-Host 'Scope: Rts.Core tests/build, Stage30 Unity readability validation/smoke/screenshot, recursion audits, UnityEngine-free scan, and git diff whitespace check.'
...
Write-Host 'Stage 30 fast checks passed.'
