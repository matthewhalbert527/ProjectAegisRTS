...
Write-ValidationSection 'Stage 31 medium checks'
Write-Host 'Purpose: pre-commit confidence for Stage 31 artist handoff/package cleanup without recursive medium chaining.'
Write-Host 'Scope: Rts.Core tests/build, direct Stage30 validation, Stage30 player-facing preservation with build/log skipped, Stage31 handoff validation, recursion audits, UnityEngine-free scan, and git diff whitespace check.'
...
Write-ValidationSection 'Direct Stage 30 Unity validation'
...
Write-ValidationSection 'Direct Stage 30 player-facing preservation'
...
Write-Host 'Stage 31 medium checks passed.'
