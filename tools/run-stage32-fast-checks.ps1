...
Write-Host 'Scope: Rts.Core tests/build, Stage32 Unity validation including play-mode smoke/screenshots, recursion audits, UnityEngine-free scan, and whitespace.'
