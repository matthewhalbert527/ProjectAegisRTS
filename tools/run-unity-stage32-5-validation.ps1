...
function Invoke-UnityBatchStage32_5 {
    param(
        [string]$UnityEditor,
        [string]$UnityProject,
...
Write-Host 'Stage 32.5 terrain art Batch01 Unity validation.'
...
Invoke-UnityBatchStage32_5 -UnityEditor $unityEditor -UnityProject $unityProject -ExecuteMethod 'ProjectAegisRTS.UnityClient.EditorTools.Stage32_5TerrainArtBatch01Importer.ImportBatch01Batch' -LogPath (Join-Path $logRoot 'stage32-5-terrain-art-import.log') -SuccessPattern 'Stage 32.5 terrain art Batch01 import completed.' -TimeoutMinutes 90
Invoke-UnityBatchStage32_5 -UnityEditor $unityEditor -UnityProject $unityProject -ExecuteMethod 'ProjectAegisRTS.UnityClient.EditorTools.Stage32_5TerrainArtBatch01Importer.ValidateBatch01Batch' -LogPath (Join-Path $logRoot 'stage32-5-terrain-art-validation.log') -SuccessPattern 'Stage 32.5 terrain art Batch01 validation passed.' -TimeoutMinutes 90

Repair-UnityGeneratedValidationWhitespace -RepoRoot $repoRoot

Write-Host "Stage 32.5 Unity validation passed. Logs: $logRoot"
