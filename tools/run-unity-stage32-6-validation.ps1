...
function Invoke-UnityBatchStage32_6 {
    param(
        [string]$UnityEditor,
        [string]$UnityProject,
...
Write-Host 'Stage 32.6 terrain art integration correction Unity validation.'
...
Invoke-UnityBatchStage32_6 -UnityEditor $unityEditor -UnityProject $unityProject -ExecuteMethod 'ProjectAegisRTS.UnityClient.EditorTools.Stage32_6TerrainArtIntegrationCorrection.GenerateStage32_6AssetsBatch' -LogPath (Join-Path $logRoot 'stage32-6-generate-assets.log') -SuccessPattern 'Stage 32.6 terrain art integration assets generated.' -TimeoutMinutes 90
Invoke-UnityBatchStage32_6 -UnityEditor $unityEditor -UnityProject $unityProject -ExecuteMethod 'ProjectAegisRTS.UnityClient.EditorTools.Stage32_6TerrainArtIntegrationCorrection.CreateStage32_6ReviewSceneBatch' -LogPath (Join-Path $logRoot 'stage32-6-create-review-scene.log') -SuccessPattern 'Stage 32.6 terrain art integration review scene created.' -TimeoutMinutes 90
Invoke-UnityBatchStage32_6 -UnityEditor $unityEditor -UnityProject $unityProject -ExecuteMethod 'ProjectAegisRTS.UnityClient.EditorTools.Stage32_6TerrainArtIntegrationCorrection.ValidateStage32_6Batch' -LogPath (Join-Path $logRoot 'stage32-6-validation.log') -SuccessPattern 'Stage 32.6 terrain art integration validation passed.' -TimeoutMinutes 90
Invoke-UnityBatchStage32_6 -UnityEditor $unityEditor -UnityProject $unityProject -ExecuteMethod 'ProjectAegisRTS.UnityClient.EditorTools.Stage32_6TerrainArtIntegrationCorrection.CaptureStage32_6ScreenshotsBatch' -LogPath (Join-Path $logRoot 'stage32-6-screenshot-capture.log') -SuccessPattern 'Stage 32.6 screenshot capture completed.' -TimeoutMinutes 90

Repair-UnityGeneratedValidationWhitespace -RepoRoot $repoRoot

Write-Host "Stage 32.6 Unity validation passed. Logs: $logRoot"
