    ...
    public static class AegisBiomeVisualTheme
    {
        ...
        public static AegisMapVisualTheme DebugVisualTheme()
        {
            var theme = BaseTheme("debug", "Debug Visual Theme", "debug")
                .Add("terrain.grass", new Color(0.22f, 0.36f, 0.17f, 1f))
                .Add("terrain.dark_grass", new Color(0.12f, 0.24f, 0.10f, 1f))
                ...
                .Add("road.dirt", new Color(0.34f, 0.27f, 0.19f, 0.30f), transparent: true)
                ...
                .Add("river.bank_erosion", new Color(0.20f, 0.13f, 0.075f, 0.42f), transparent: true, albedo: "Decals/River/shoreline_erosion_cut_01.png")
                .Add("river.bank_pebbles", new Color(0.38f, 0.32f, 0.23f, 0.44f), transparent: true, albedo: "Decals/River/shoreline_wet_pebbles_01.png")
                ...
                .Add("terrain.grass_mottle", new Color(0.08f, 0.16f, 0.06f, 0.24f), transparent: true, albedo: "Decals/Roads/soft_dust_overlay.png")
                .Add("terrain.grass_micro_mottle", new Color(0.12f, 0.25f, 0.08f, 0.14f), transparent: true, albedo: "Decals/Roads/soft_dust_overlay.png")
                .Add("terrain.dry_grass_mottle", new Color(0.45f, 0.36f, 0.19f, 0.12f), transparent: true, albedo: "Decals/Roads/soft_dust_overlay.png")
                .Add("terrain.surface_shadow_mottle", new Color(0.015f, 0.024f, 0.012f, 0.07f), transparent: true, albedo: "Decals/Battlefield/scorch_mark_02.png")
                .Add("terrain.dirt_mottle", new Color(0.42f, 0.31f, 0.20f, 0.38f), transparent: true, albedo: "Decals/Roads/soft_dust_overlay.png")
                .Add("terrain.dirt_pebble_mottle", new Color(0.30f, 0.25f, 0.18f, 0.20f), transparent: true, albedo: "Decals/Battlefield/rubble_scatter_02.png")
                ...
                .Add("terrain.macro_grass_variation", new Color(0.08f, 0.18f, 0.06f, 0.105f), transparent: true, albedo: "Decals/Roads/soft_dust_overlay.png")
                .Add("terrain.macro_dry_grass", new Color(0.42f, 0.34f, 0.17f, 0.060f), transparent: true, albedo: "Decals/Roads/soft_dust_overlay.png")
                .Add("terrain.macro_shadow", new Color(0.012f, 0.020f, 0.010f, 0.032f), transparent: true, albedo: "Decals/Battlefield/scorch_mark_02.png")
                .Add("terrain.macro_dirt_variation", new Color(0.40f, 0.30f, 0.19f, 0.115f), transparent: true, albedo: "Decals/Roads/soft_dust_overlay.png")
                .Add("terrain.macro_wet_lowland", new Color(0.14f, 0.095f, 0.060f, 0.145f), transparent: true, albedo: "Decals/River/muddy_shoreline_01.png")
                ...
                .Add("road.soft_dust", new Color(0.40f, 0.34f, 0.25f, 0.24f), transparent: true, albedo: "Decals/Roads/soft_dust_overlay.png")
                .Add("road.worn_edge", new Color(0.45f, 0.39f, 0.30f, 0.24f), transparent: true, albedo: "Decals/Roads/worn_path_edge_01.png")
                ...
                .Add("road.edge_grass", new Color(0.10f, 0.27f, 0.075f, 0.52f), transparent: true, albedo: "Decals/Roads/soft_dust_overlay.png")
                .Add("road.pebble_breakup", new Color(0.31f, 0.26f, 0.19f, 0.34f), transparent: true, albedo: "Decals/Battlefield/rubble_scatter_02.png")
        ...
        public static AegisMapVisualTheme DesertPrototypeVisualTheme()
        {
            var theme = BaseTheme("desert_prototype", "Desert Prototype Visual Theme", "desert")
                ...
                .Add("road.dirt", new Color(0.45f, 0.33f, 0.20f, 0.31f), transparent: true)
                ...
                .Add("river.bank_erosion", new Color(0.25f, 0.15f, 0.075f, 0.42f), transparent: true, albedo: "Decals/River/shoreline_erosion_cut_01.png")
                .Add("river.bank_pebbles", new Color(0.48f, 0.38f, 0.25f, 0.44f), transparent: true, albedo: "Decals/River/shoreline_wet_pebbles_01.png")
                ...
                .Add("terrain.grass_micro_mottle", new Color(0.50f, 0.42f, 0.22f, 0.14f), transparent: true, albedo: "Decals/Roads/soft_dust_overlay.png")
                .Add("terrain.dry_grass_mottle", new Color(0.62f, 0.45f, 0.22f, 0.12f), transparent: true, albedo: "Decals/Roads/soft_dust_overlay.png")
                .Add("terrain.surface_shadow_mottle", new Color(0.030f, 0.023f, 0.014f, 0.07f), transparent: true, albedo: "Decals/Battlefield/scorch_mark_02.png")
                .Add("terrain.dirt_mottle", new Color(0.56f, 0.40f, 0.24f, 0.38f), transparent: true, albedo: "Decals/Roads/soft_dust_overlay.png")
                .Add("terrain.dirt_pebble_mottle", new Color(0.39f, 0.31f, 0.22f, 0.20f), transparent: true, albedo: "Decals/Battlefield/rubble_scatter_02.png")
                ...
                .Add("terrain.macro_grass_variation", new Color(0.34f, 0.28f, 0.15f, 0.115f), transparent: true, albedo: "Decals/Roads/soft_dust_overlay.png")
                .Add("terrain.macro_dry_grass", new Color(0.58f, 0.43f, 0.20f, 0.070f), transparent: true, albedo: "Decals/Roads/soft_dust_overlay.png")
                .Add("terrain.macro_shadow", new Color(0.025f, 0.020f, 0.012f, 0.034f), transparent: true, albedo: "Decals/Battlefield/scorch_mark_02.png")
                .Add("terrain.macro_dirt_variation", new Color(0.53f, 0.37f, 0.22f, 0.120f), transparent: true, albedo: "Decals/Roads/soft_dust_overlay.png")
                .Add("terrain.macro_wet_lowland", new Color(0.20f, 0.13f, 0.075f, 0.145f), transparent: true, albedo: "Decals/River/muddy_shoreline_01.png")
                ...
                .Add("road.soft_dust", new Color(0.49f, 0.38f, 0.24f, 0.25f), transparent: true, albedo: "Decals/Roads/soft_dust_overlay.png")
                .Add("road.worn_edge", new Color(0.50f, 0.41f, 0.29f, 0.25f), transparent: true, albedo: "Decals/Roads/worn_path_edge_01.png")
                ...
                .Add("road.edge_grass", new Color(0.43f, 0.35f, 0.18f, 0.45f), transparent: true, albedo: "Decals/Roads/soft_dust_overlay.png")
                .Add("road.pebble_breakup", new Color(0.42f, 0.32f, 0.21f, 0.34f), transparent: true, albedo: "Decals/Battlefield/rubble_scatter_02.png")
