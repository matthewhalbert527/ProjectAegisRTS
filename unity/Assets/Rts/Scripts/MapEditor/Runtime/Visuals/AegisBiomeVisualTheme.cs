    ...
    public static class AegisBiomeVisualTheme
    {
        ...
        public static AegisMapVisualTheme DebugVisualTheme()
        {
            var theme = BaseTheme("debug", "Debug Visual Theme", "debug")
                ...
                .Add("river.shoreline", new Color(0.22f, 0.15f, 0.10f, 0.18f), transparent: true)
                ...
                .Add("terrain.grass_mottle", new Color(0.10f, 0.22f, 0.08f, 0.20f), transparent: true, albedo: "Decals/Roads/soft_dust_overlay.png")
                ...
                .Add("terrain.blend_grass", new Color(0.10f, 0.20f, 0.07f, 0.18f), transparent: true, albedo: "Decals/Roads/soft_dust_overlay.png")
        ...
        public static AegisMapVisualTheme DesertPrototypeVisualTheme()
        {
            var theme = BaseTheme("desert_prototype", "Desert Prototype Visual Theme", "desert")
                ...
                .Add("river.shoreline", new Color(0.31f, 0.21f, 0.13f, 0.22f), transparent: true)
                ...
                .Add("terrain.grass_mottle", new Color(0.38f, 0.31f, 0.18f, 0.20f), transparent: true, albedo: "Decals/Roads/soft_dust_overlay.png")
                ...
                .Add("terrain.blend_grass", new Color(0.40f, 0.31f, 0.18f, 0.18f), transparent: true, albedo: "Decals/Roads/soft_dust_overlay.png")
